...
export const FIGHTER_STATS = {
  gojo: {
    name: 'Gojo Satoru',
    weight: 95, walkSpeed: 1.1, runSpeed: 1.8, jumpHeight: 35,
  ...
  yuji: {
    name: 'Yuji Itadori',
    weight: 88, walkSpeed: 1.3, runSpeed: 2.2, jumpHeight: 40,
  ...
  sukuna: {
    name: 'Ryomen Sukuna',
    weight: 100, walkSpeed: 1.0, runSpeed: 1.7, jumpHeight: 33,
  ...
  mahito: {
    name: 'Mahito',
    weight: 85, walkSpeed: 1.15, runSpeed: 1.9, jumpHeight: 37,
  ...
  todo: {
    name: 'Aoi Todo',
    weight: 115, walkSpeed: 0.9, runSpeed: 1.5, jumpHeight: 30,
